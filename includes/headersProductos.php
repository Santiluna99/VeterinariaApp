...
<body>
    <header>
        ...
        <a href="../crudProducto/registerProducto.php">CREATE</a>
        <a href="../crudProducto/read.php">READ</a>
        <a href="../crudProducto/delete.php">DELETE</a>
        <a href="../crudProducto/update.php">UPDATE</a>
